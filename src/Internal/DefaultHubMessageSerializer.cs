...
internal class DefaultHubMessageSerializer
{
    ...
    public DefaultHubMessageSerializer(IHubProtocolResolver hubProtocolResolver,
        IList<string>? globalSupportedProtocols, IList<string>? hubSupportedProtocols)
    {
        ...
        {
            var protocol = hubProtocolResolver.GetProtocol(protocolName,
